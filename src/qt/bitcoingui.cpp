    ...
    platformStyle(_platformStyle)
{
    ...
    setWindowIcon(QIcon(":icons/verium"));
    qApp->setWindowIcon(QIcon(":icons/verium"));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Verium address"));
    ...
    //forumsAction = new QAction(platformStyle->SingleColorIcon(":/icons/chat"), tr("Support"), this);
    forumsAction = new QAction(QIcon(":/icons/chat"), tr("Support"), this);
    forumsAction->setStatusTip(tr("Get Support and connect with community"));
    forumsAction->setStatusTip(forumsAction->statusTip());
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Verium command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::gotoForumsPage()
{
    ...
    if (walletFrame) walletFrame->gotoForumsPage();
}
...
{
    QString strTitle = tr("Verium"); // default title
...
{
    /* Verium: We do not want to show the model overlay.
     */
}
