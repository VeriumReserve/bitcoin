...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s verium-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  verium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded verium transaction") + "\n" +
              "  verium-tx [options] -create [commands]   " + _("Create hex-encoded verium transaction") + "\n" +
              "\n";
