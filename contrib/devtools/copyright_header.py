#!/usr/bin/env python3
# Copyright (c) 2016-2017 The Verium Core developers
...
EXPECTED_HOLDER_NAMES = [
    "Satoshi Nakamoto\n",
    "The Verium Core developers\n",
    "The Verium Core developers \n",
    "Verium Core Developers\n",
    "the Verium Core developers\n",
    "The Verium developers\n",
...
Arguments:
    <base_directory> - The base directory of a verium source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Verium Core developers'
...
CPP_HEADER = '''
// Copyright (c) %s The Verium Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The Verium Core developers'
                 % (filename))
...
Arguments:
    <file> - A source file in the verium repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Verium
