...
Also test that nodes that send unsupported service bits to veriumd are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if veriumd ban behavior changes
    def on_open(self):
        super().on_open()
