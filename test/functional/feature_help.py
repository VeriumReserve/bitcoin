...
"""Verify that starting verium with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start verium with -h for help text")
        ...
        self.log.info("Start verium with -version for version information")
