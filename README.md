...
out collectively by the network. Verium Core is the name of open source
software which enables the use of this currency.

For more information, as well as an immediately useable, binary version of
the Verium Core software, see https://www.vericonomy.com.
License
-------

Verium Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
regularly to indicate new official, stable release versions of Verium Core.
...
[Verium Core's Transifex page](https://www.transifex.com/projects/p/bitcoin/).
